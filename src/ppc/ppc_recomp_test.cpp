...
void sub_82090000(PPCContext* ctx) {
    ...
    ctx_arrow(ctx)->cr[0].compare<int64_t>(ctx_arrow(ctx)->r5.s64, ctx_arrow(ctx)->r3.s64, 0);
    
    // Store result based on comparison
    if (ctx_arrow(ctx)->cr[0].gt()) {
...
void sub_82090010(PPCContext* ctx, uint32_t) {
    ...
    ctx_arrow(ctx)->cr[0].compare<int64_t>(ctx_arrow(ctx)->r5.s64, ctx_arrow(ctx)->r4.s64, 0);
    
    // Store result based on comparison
    if (ctx_arrow(ctx)->cr[0].lt()) {
...
void sub_82090020(PPCContext* ctx, uint32_t) {
    ...
    ctx_arrow(ctx)->cr[0].compare<int64_t>(ctx_arrow(ctx)->r3.s64, orig_r3, 0);
...
void sub_82090040(PPCContext* ctx) {
    ...
    ctx_arrow(ctx)->cr[0].compare<uint32_t>(val1, val2, 0);
...
void __imp__sub_820901B0(PPCContext* ctx) {
    ...
    if (ctx_arrow(ctx)->cr[0].eq()) {
        ctx_arrow(ctx)->r3.u32 = 1;
    } else if (ctx_arrow(ctx)->cr[0].lt()) {
        ctx_arrow(ctx)->r3.u32 = 2;
    } else if (ctx_arrow(ctx)->cr[0].gt()) {
...
void __imp__sub_820901F0(PPCContext* ctx) {
    ...
    ctx_arrow(ctx)->cr[0].compare<uint32_t>(ctx_arrow(ctx)->r3.u32, ctx_arrow(ctx)->r4.u32, ctx_arrow(ctx)->xer.value);
    ctx_arrow(ctx)->cr[1].compare<uint32_t>(ctx_arrow(ctx)->r5.u32, ctx_arrow(ctx)->r6.u32, ctx_arrow(ctx)->xer.value);
}
...
void __imp__sub_82090200(PPCContext* ctx) {
    ...
    if (ctx_arrow(ctx)->cr[0].eq() && ctx_arrow(ctx)->cr[1].eq()) {
        ctx_arrow(ctx)->r3.u32 = 1;
    } else if (ctx_arrow(ctx)->cr[0].lt() || ctx_arrow(ctx)->cr[1].lt()) {
        ctx_arrow(ctx)->r3.u32 = 2;
    } else if (ctx_arrow(ctx)->cr[0].gt() && (((((((((((((!ctx)))))))))))))->cr[1].gt()) {
        ctx_arrow(ctx)->r3.u32 = 3;
    }
}
...
void __imp__sub_82090210(PPCContext* ctx) {
    ...
    ctx_arrow(ctx)->cr[0].compare<uint32_t>(val1, val2, ctx_arrow(ctx)->xer.value);
}
